...
from .views import PostListView, PostDetailView, PostDeleteView, CategoryView, search, AboutView, ContactView, SubscribeView, AddPostView, AddCategoryView, PostEditView, PostDeleteView
...
urlpatterns = [
    ...
    path('category_detail/<str:cats>/',CategoryView, name='category_detail'),
